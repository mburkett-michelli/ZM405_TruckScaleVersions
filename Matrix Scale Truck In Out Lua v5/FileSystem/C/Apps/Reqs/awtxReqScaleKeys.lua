...
function awtxReq.keypad.onUnitsKeyUp()
  -- Default functionality.
  -- Redefine function to change functionality
  currentU = awtx.weight.getCurrentUnits(1)
  awtx.weight.cycleUnits()
  answer = awtx.weight.getCurrentUnits(1)
  storedVariables.truckOnScaleWeight = awtx.weight.convertWeight(currentU,storedVariables.truckOnScaleWeight,answer ,1)
  storedVariables.switchToRed = awtx.weight.convertWeight(currentU,storedVariables.switchToRed,answer ,1)
  storedVariables.stp22Reset = awtx.weight.convertWeight(currentU,storedVariables.stp22Reset,answer ,1)
...
--  stp22Reset = tonumber(storedVariables.stp22Reset)                   --80.4
  ...
  print(storedVariables.truckOnScaleWeight .."," .. storedVariables.switchToRed .. "," .. storedVariables.stp22Reset  .. "," ..answer)
end
